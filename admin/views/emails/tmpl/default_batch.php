...
<div class="modal hide fade" id="collapseModal">
	...
	<div class="modal-body modal-batch">
        ...
        <form action="<?php echo JRoute::_("index.php?option=com_emailtemplates"); ?>" method="post" id="js-emails-batch-form">

            <div class="well well-small">
                <label class="radio">
                    <input type="radio" name="action" value="copy" checked />
                    <strong><?php echo JText::_('COM_EMAILTEMPLATES_COPY_EMAILS'); ?></strong>
                </label>
            ...
            <input type="hidden" name="task" value="emails.batch" />
	...
	<div class="modal-footer">
        ...
        <button class="btn btn-primary" type="submit" id="js-emails-btn-batch">
